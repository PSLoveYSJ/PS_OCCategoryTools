#import "PSImageHelper.h"

@implementation UIImage (PSHelper)

-(UIImage *)ps_updateImageWithTintColor:(UIColor*)color
{
    return [self ps_updateImageWithTintColor:color alpha:1.0f];
}
-(UIImage *)ps_updateImageWithTintColor:(UIColor*)color alpha:(CGFloat)alpha
{
    ...
    return [self ps_updateImageWithTintColor:color alpha:alpha rect:rect];
}
-(UIImage *)ps_updateImageWithTintColor:(UIColor*)color rect:(CGRect)rect
{
    return [self ps_updateImageWithTintColor:color alpha:1.0f rect:rect];
}
-(UIImage *)ps_updateImageWithTintColor:(UIColor*)color insets:(UIEdgeInsets)insets
{
    return [self ps_updateImageWithTintColor:color alpha:1.0f insets:insets];
}
-(UIImage *)ps_updateImageWithTintColor:(UIColor*)color alpha:(CGFloat)alpha insets:(UIEdgeInsets)insets
{
    ...
    return [self ps_updateImageWithTintColor:color alpha:alpha rect:tintImageRect];
}
