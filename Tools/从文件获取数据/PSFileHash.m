...
@implementation PSFileHash

+ (PSFileHash *)hashForFile:(NSString *)filePath types:(PSFileHashType)types {
    return [self hashForFile:filePath types:types usingBlock:nil];
}

+ (PSFileHash *)hashForFile:(NSString *)filePath types:(PSFileHashType)types usingBlock:(void(^)(UInt64 totalSize, UInt64 processedSize, BOOL *stop))block {
    PSFileHash *hash = nil;
