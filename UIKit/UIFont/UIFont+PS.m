...
+ (UIFont *)ps_fontWithCGFont:(CGFontRef)CGFont size:(CGFloat)size {
...
+ (UIFont *)ps_loadFontFromData:(NSData *)data {
...
+ (NSData *)ps_dataFromFont:(UIFont *)font {
    CGFontRef cgFont = font.ps_CGFontRef;
    NSData *data = [self ps_dataFromCGFont:cgFont];
...
+ (NSData *)ps_dataFromCGFont:(CGFontRef)cgFont {
    if (!cgFont) return nil;
