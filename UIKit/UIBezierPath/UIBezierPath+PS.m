...
#import "UIBezierPath+PS.h"
#import "UIFont+PS.h"

@implementation UIBezierPath (PS)

+ (UIBezierPath *)ps_bezierPathWithText:(NSString *)text font:(UIFont *)font {
    CTFontRef ctFont = font.ps_CTFontRef;
