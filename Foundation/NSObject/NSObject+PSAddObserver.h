...
@interface NSObject (PSAddObserver)
 ...
 */
- (void)ps_addObserverBlockForKeyPath:(NSString*)keyPath block:(void (^)(id obj, id oldVal, id newVal))block;
 ...
 */
- (void)ps_addNotificationForName:(NSString *)name block:(void (^)(NSNotification *notification))block;
 ...
 *  @param userInfo 数据字典
 */
- (void)ps_postNotificationWithName:(NSString *)name userInfo:(nullable NSDictionary *)userInfo;
