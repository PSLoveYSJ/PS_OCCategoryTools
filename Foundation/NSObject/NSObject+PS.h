 ...
 */
- (nullable id)ps_performSelectorWithArgs:(SEL)sel, ...;
 ...
 */
- (void)ps_performSelectorWithArgs:(SEL)sel afterDelay:(NSTimeInterval)delay, ...;
 ...
 */
- (nullable id)ps_performSelectorWithArgsOnMainThread:(SEL)sel waitUntilDone:(BOOL)wait, ...;
 ...
 */
- (nullable id)ps_performSelectorWithArgs:(SEL)sel onThread:(NSThread *)thread waitUntilDone:(BOOL)wait, ...;
 ...
 */
- (void)ps_performSelectorWithArgsInBackground:(SEL)sel, ...;
 ...
 */
- (void)ps_performSelector:(SEL)sel afterDelay:(NSTimeInterval)delay;
 ...
 */
- (void)ps_setAssociateValue:(nullable id)value withKey:(void *)key;
...
/**
 ...
 @param key    The pointer to get value from `self`.
 */
- (void)ps_setAssociateWeakValue:(nullable id)value withKey:(void *)key;
...
/**
 ...
 @param key The pointer to get value from `self`.
 */
- (nullable id)ps_getAssociatedValueForKey:(void *)key;

/**
 Remove all associated values.
 */
- (void)ps_removeAssociatedValues;
 ...
 */
- (nullable id)ps_deepCopyWithArchiver:(Class)archiver unarchiver:(Class)unarchiver;
