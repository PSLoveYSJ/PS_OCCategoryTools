...
- (NSString *)ps_hmacStringUsingAlg:(CCHmacAlgorithm)alg withKey:(NSString *)key {
    size_t size;
    switch (alg) {
...
- (NSData *)ps_hmacDataUsingAlg:(CCHmacAlgorithm)alg withKey:(NSData *)key {
    size_t size;
    switch (alg) {
        case kCCHmacAlgMD5: size = CC_MD5_DIGEST_LENGTH; break;
        case kCCHmacAlgSHA1: size = CC_SHA1_DIGEST_LENGTH; break;
...
- (NSString *)ps_hmacMD5StringWithKey:(NSString *)key {
    return [self ps_hmacStringUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSData *)ps_hmacMD5DataWithKey:(NSData *)key {
    return [self ps_hmacDataUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSString *)ps_hmacSHA1StringWithKey:(NSString *)key {
    return [self ps_hmacStringUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSData *)ps_hmacSHA1DataWithKey:(NSData *)key {
    return [self ps_hmacDataUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSString *)ps_hmacSHA224StringWithKey:(NSString *)key {
    return [self ps_hmacStringUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSData *)ps_hmacSHA224DataWithKey:(NSData *)key {
    return [self ps_hmacDataUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSString *)ps_hmacSHA256StringWithKey:(NSString *)key {
    return [self ps_hmacStringUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSData *)ps_hmacSHA256DataWithKey:(NSData *)key {
    return [self ps_hmacDataUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSString *)ps_hmacSHA384StringWithKey:(NSString *)key {
    return [self ps_hmacStringUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSData *)ps_hmacSHA384DataWithKey:(NSData *)key {
    return [self ps_hmacDataUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSString *)ps_hmacSHA512StringWithKey:(NSString *)key {
    return [self ps_hmacStringUsingAlg:kCCHmacAlgSHA512 withKey:key];
}

- (NSData *)ps_hmacSHA512DataWithKey:(NSData *)key {
    return [self ps_hmacDataUsingAlg:kCCHmacAlgSHA512 withKey:key];
}
...
- (NSData *)ps_aes256EncryptWithKey:(NSData *)key iv:(NSData *)iv {
...
- (NSData *)ps_aes256DecryptWithkey:(NSData *)key iv:(NSData *)iv {
    if (key.length != 16 && key.length != 24 && key.length != 32) {
        return nil;
    }
    if (iv.length != 16 && iv.length != 0) {
...
+ (NSData *)ps_dataWithHexString:(NSString *)hexStr {
...
+ (NSData *)ps_dataWithBase64EncodedString:(NSString *)base64EncodedString {
...
+ (NSData *)ps_dataNamed:(NSString *)name {
...
- (id)ps_jsonValueDecoded {
    ...
    if (error) {
        DebugLog(@"jsonValueDecoded error:%@", error);
    }
    return value;
}
